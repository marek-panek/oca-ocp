package oracle.certified.associate.topic4.arrays;

import java.util.Arrays;

/**
 * <b>| Topic 4.1 | -  <i>Declare, instantiate, initialize and use a one-dimensional array.</i></b><br/>
 * <b>| Topic 4.2 | -  <i>Declare, instantiate, initialize and use multi-dimensional array.</i></b>
 * 
 * <p>
 ...
 * 
 *  <ul>
 *      <li>In Java, arrays are objects.</li>
 *      <li>Arrays can be of primitive data types or reference types.
 *          <ul>
 *              <li>In the former case, all elements in the array are of a specific primitive data type.</li>
 *              <li>In the latter case, all elements are references of a specific reference type.<br/>
 *                  References in the array can then denote objects of this reference type or its sub-types.
 *              </li>
 *          </ul>
 *      </li>
 *      <li>Each array object has a final field called length, which specifies the array size, i.e.,
 *          the number of elements the array can accommodate.
 *      </li>
 *      <li>
 *          The first element is always at index 0 and the last element at index n-1,
 *          where n is the value of the length field in the array.
 *      </li>
 *  </ul>
 */
public class JavaArraysDemo {
    ...
    public static void main(String[] args) {
        ...
        int mtab4[][] = { { 1, 2, 3 }, { 4, 5, 6 }, { 7, 8, 9 } };

        String[][] raggedArray = { { "One", null, "Two" }, // 1. row is an array of 3 elements.
