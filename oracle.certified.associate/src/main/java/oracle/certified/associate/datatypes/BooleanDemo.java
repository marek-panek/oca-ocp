...
public class BooleanDemo {
    ...
    public static void main(String[] args) {
        ...
        Utils.prettyPrint("Boolean(String s)");
        ...
        Utils.prettyPrint("parseBoolean(String s)");
        ...
        Utils.prettyPrint("valueOf(String s)");
        ...
        Utils.prettyPrint("compareTo(Boolean b)");
        ...
        Utils.prettyPrint("clazz.getName()");
        System.out.println(clazz.getName());
        Utils.prettyPrint("clazz.getSimpleName()");
